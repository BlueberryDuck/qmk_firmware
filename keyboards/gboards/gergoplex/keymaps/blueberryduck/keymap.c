 ...
 * |-------+------+-------+-------+-----|	|-----+-----+-----+-----------|
 * |META/F6|ALT/F7|SHFT/F8|CTRL/F9| F10 |	|     |  4  |  5  |  6  |  0  | 
 * |-------+------+-------+-------+-----|	|-----+-----+-----+-----------|
 * |  F11  | F12  |       |       |RESET|	|     |  1  |  2  |  3  |  ,  |
 * '------------------------------------'	'-----------------------------'
 * 				      .-----------------.	.-----------------.   
...
[NUMB] = LAYOUT_split_3x5_3(
    ...
    MT(MOD_LGUI,KC_F6),	MT(MOD_LALT,KC_F7),	MT(MOD_LSFT,KC_F8),	MT(MOD_LCTL,KC_F9),	KC_F10,		KC_TRNS,	KC_P4,	KC_P5,	KC_P6,	KC_P0,
    KC_F11,				KC_F12,				KC_TRNS,			KC_TRNS,			RESET,		KC_TRNS,	KC_P1,	KC_P2,	KC_P3,	KC_PDOT,
